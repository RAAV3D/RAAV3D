...
loader.load(
    'bathroom(18x12)1.glb',  // File name as specified
    function (gltf) {
        ...
        gltfScene.traverse((child) => {
            if (child.isMesh) {
                ...
                const meshNames = ['D001', 'D002', 'D003', 'D004', 'D005', 'D006', 'D007', 'D008',
                                   ...
                                   'D041', 'D042', 'D043', 'D044', 'D045', 'D046', 'D047', 'D048','D049', 'D050', 'D051', 'D052',
                                   ...
                                   'F033', 'F034', 'F035', 'F036'];  // Added F001-F036 for flooring
        ...
        gltfScene.traverse((child) => {
            if (child.isMesh) {
                ...
                const dMeshes = ['D001', 'D002', 'D003', 'D004', 'D005', 'D006', 'D007', 'D008',
                                 ...
                                 'D025', 'D026', 'D027', 'D028', 'D029', 'D030', 'D031', 'D032',
                                 'D033', 'D034', 'D035', 'D036', 'D037', 'D038', 'D039', 'D040',
                                 'D041', 'D042', 'D043', 'D044', 'D045', 'D046', 'D047', 'D048','D049', 'D050', 'D051', 'D052','D053',];
                ...
                const fMeshes = ['F001', 'F002', 'F003', 'F004', 'F005', 'F006', 'F007', 'F008',
                                 ...
                                 'F017', 'F018', 'F019', 'F020', 'F021', 'F022', 'F023', 'F024',
                                 'F025', 'F026', 'F027', 'F028', 'F029', 'F030', 'F031', 'F032',
                                 'F033', 'F034', 'F035', 'F036'];  // Expanded to F001-F036 for flooring
...
function applyScannedImage(url, category) {
    ...
    textureLoader.load(url, (texture) => {
        ...
        if (category === 'F') uploadedTextureF = texture;
