...
let uploadedTextureL = null, uploadedTextureD = null, uploadedTextureF = null;
...
const DB_NAME = "TileViewerStorage_562x4";
const DB_VERSION = 1;
  ...
  document.getElementById("downloadBtn").addEventListener("click", async () => {
    ...
    try {
      ...
      recorder.onstop = () => {
        ...
        a.href = url;
        a.download = `Kitchen_design_${currentDesignIndex + 1 || 1}.${fileExtension}`;
