...
loader.load(
    '/public/models/kitchen_18x12_3.glb',  // File name as specified
    function (gltf) {
        ...
        gltfScene.traverse((child) => {
            if (child.isMesh) {
               ...
               const hlMeshes = ['HL001', 'HL002', 'HL003', 'HL004', 'HL005', 'HL006', 'HL007', 'HL008',
                                 ...
                                 'HL025', 'HL026', 'HL027', 'HL028', 'HL029', 'HL030', 'HL031', 'HL032',
                                 'HL033', 'HL034', 'HL035', 'HL036', 'HL037', 'HL038', 'HL039', 'HL040',
                                 'HL041', 'HL042', 'HL043', 'HL044', 'HL045', 'HL046', 'HL047', 'HL048',];  // Placeholder - adjust if your model has different HL meshes
