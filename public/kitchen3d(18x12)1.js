...
loader.load(
    '/public/models/kitchen_18x12_1.glb',  // File name as specified
    function (gltf) {
        ...
        gltfScene.traverse((child) => {
            if (child.isMesh) {
                ...
                const meshNames = ['D001', 'D002', 'D003', 'D004', 'D005', 'D006', 'D007', 'D008',
                                   ...
                                   'HL001', 'HL002', 'HL003', 'HL004', 'HL005', 'HL006', 'HL007', 'HL008',
                                   ...
                                   'L089', 'L090', 'L091', 'L092', 'L093', 'L094', 'L095', 'L096'];  // Removed F001-F036
    ...
    if (file) {
        ...
        textureLoader.load(
            ...
            function(texture) {
                ...
                uploadedTextureL.rotation = 0;  // Removed 90-degree rotation
    ...
    if (file) {
        ...
        textureLoader.load(
            ...
            function(texture) {
                ...
                uploadedTextureD.rotation = 0;  // Removed 90-degree rotation
    ...
    if (file) {
        ...
        textureLoader.load(
            ...
            function(texture) {
                ...
                uploadedTextureHL.rotation = 0;  // Removed 90-degree rotation
...
generateBtn.addEventListener('click', function() {
    if (modelLoaded) {
        ...
        if (boundingBox) {
            ...
            controls.maxDistance = maxDim * 0.3;  // Allow zooming out to twice the max dimension
        }
        ...
        gltfScene.traverse((child) => {
            if (child.isMesh) {
                ...
                const hlMeshes = ['HL001', 'HL002', 'HL003', 'HL004', 'HL005', 'HL006', 'HL007', 'HL008',
                                  'HL009', 'HL010', 'HL011', 'HL012', 'HL013', 'HL014', 'HL015', 'HL016',
                                  'HL017', 'HL018', 'HL019', 'HL020', 'HL021', 'HL022', 'HL023', 'HL024',];  // Placeholder - adjust if your model has different HL meshes
...
function applyScannedImage(url, category) {
    ...
    textureLoader.load(url, (texture) => {
        texture.rotation = 0;  // Removed 90-degree rotation
        texture.flipY = false;
        ...
        if (category === 'HL') uploadedTextureHL = texture;
