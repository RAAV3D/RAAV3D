/* Unified viewer with 15 design buttons, auto-rotation and zoom limits
   - Edit the modelPaths array below (15 entries). Put your GLB filenames or URLs.
   - If a slot is empty (""), its button will be disabled.
*/

/* ========== Put your GLB filenames/URLs here (15 entries) ========== */
const modelPaths = [
  "/public/models/bathroom(18x12)1.glb", // Design 1
  "/public/models/bathroom(18x12)2.glb", // Design 2
  "/public/models/bathroom(18x12)3.glb", // Design 3
  "/public/models/bathroom(18x12)4.glb", // Design 4
  "/public/models/bathroom(18x12)5.glb", // Design 5
  "/public/models/bathroom(18x12)6.glb", // Design 6
  "/public/models/bathroom(18x12)7.glb", // Design 7
  "/public/models/bathroom(18x12)8.glb", // Design 8
  "/public/models/bathroom(18x12)9.glb", // Design 9
  "/public/models/bathroom(18x12)10.glb", // Design 10
  "/public/models/bathroom(18x12)11.glb", // Design 11
  "/public/models/bathroom(18x12)12.glb", // Design 12
  "/public/models/bathroom(18x12)13.glb", // Design 13
  "/public/models/bathroom(18x12)14.glb", // Design 14
  "/public/models/bathroom(18x12)15.glb", // Design 15
  "/public/models/bathroom(18x12)16.glb", // Design 16
  "/public/models/bathroom(18x12)17.glb", // Design 17
  ""  // Design 18
];
/* =================================================================== */
...
const hlMeshes = ['HL001', 'HL002', 'HL003', 'HL004', 'HL005', 'HL006', 'HL007', 'HL008',
                                   ...
                                   'HL017', 'HL018', 'HL019', 'HL020', 'HL021', 'HL022', 'HL023', 'HL024',]; // extend as needed
...
let uploadedTextureL = null, uploadedTextureD = null, uploadedTextureHL = null;
...
function populateFromScannedFile(file, key) {
  const map = { L: 'fileInputL', D: 'fileInputD', HL: 'fileInputHL' };
  ...
  if (key === 'HL') handleFile(file, document.getElementById('previewHL'), document.getElementById('sectionHL'), document.getElementById('clearHL'), document.getElementById('errorHL'), 'HL');
}
...
// ✅ Updated fullscreen code — removes top/bottom black bars
...
// ✅ Updated Download button: records a 10-second WebM video of the 3D view
...
function wireQrButtons() {
  ...
  document.getElementById('scanHL').addEventListener('click', () => openQrScannerFor('HL'));
...
/* ========== Create footer buttons (16) and attach handlers ========== */
