...
loader.load(
    '/models/bathroom(18x12)11.glb',  // File name as specified
    function (gltf) {
        ...
        gltfScene.traverse((child) => {
            if (child.isMesh) {
                ...
                const meshNames = ['D001', 'D002', 'D003', 'D004', 'D005', 'D006', 'D007', 'D008',
                                   ...
                                   'HL017', 'HL018', 'HL019', 'HL020', 'HL021', 'HL022', 'HL023', 'HL024'];  // Removed L and F meshes from meshNames
...
function handleFileUpload(input, preview, error, clearBtn, container, dragText) {
    ...
    clearBtn.addEventListener('click', () => {
        ...
        if (category === 'D') uploadedTextureD = null;
    ...
    if (modelLoaded) {
        ...
        gltfScene.traverse((child) => {
            if (child.isMesh) {
                ...
                if (dMeshes.includes(child.name) && uploadedTextureD) {
