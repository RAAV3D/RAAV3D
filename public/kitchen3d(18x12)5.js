...
loader.load(
    '/models/kitchen(2x4)1.glb',  // File name as specified
    function (gltf) {
        ...
        gltfScene.traverse((child) => {
            if (child.isMesh) {
                ...
                const meshNames = ['L001', 'L002', 'L003', 'L004', 'L005', 'L006', 'L007', 'L008',
                                   ...
                                   'L089', 'L090', 'L091', 'L092', 'L093', 'L094', 'L095', 'L096'];  // Removed HL001-HL024
