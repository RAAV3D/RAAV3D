...
loader.load(
    '/public/models/bathroom(2x4)2.glb',  // File name as specified
    function (gltf) {
        ...
        gltfScene.traverse((child) => {
            if (child.isMesh) {
                ...
                const meshNames = ['D001', 'D002', 'D003', 'D004', 'D005', 'D006', 'D007', 'D008',
                                   ...
                                   'L041', 'L042', 'L043', 'L044', 'L045', 'L046', 'L047', 'L048'];  // Removed HL and F meshes
                if (meshNames.includes(child.name)) {
                    ...
                    // Glass-like reflections for tiles
