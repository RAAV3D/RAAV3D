        ...
        gltfScene.traverse((child) => {
            if (child.isMesh) {
                ...
                const meshNames = ['D001', 'D002', 'D003', 'D004', 'D005', 'D006', 'D007', 'D008',
                                   ...
                                   'L041', 'L042', 'L043', 'L044', 'L045', 'L046', 'L047', 'L048'];  // Removed HL and F meshes from meshNames
...
downloadBtn.addEventListener('click', async () => {
    ...
    const stream = canvas.captureStream(30); // 30 FPS    mediaRecorder = new MediaRecorder(stream, { mimeType: 'video/webm;codecs=vp9' });
